package nus.edu.sg.iss.app.workshop23.controller;
...
import nus.edu.sg.iss.app.workshop23.repository.OrderDetailsRepo;
...
public class OrderDetailsController {
    ...
    public ResponseEntity<String> getOrderDetailsInfo(@PathVariable Integer orderId){
        OrderDetails orderDetails = repo.getOrderDetailsWithDiscount(orderId);
